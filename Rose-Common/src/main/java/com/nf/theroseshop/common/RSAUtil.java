...
public class RSAUtil {
	...
	private static String modulus = "";
	
	private static String public_exponent = "65537";
	
	private static String private_exponent = "";
	...
	/**
	 * 使用模和指数生成RSA公钥
	 * 注意：【此代码用了默认补位方式，为RSA/None/PKCS1Padding，不同JDK默认的补位方式可能不同，如Android默认是RSANone/NoPadding】
	 *
	 * @param modulus 	模
	 * @param exponent 	指数
	 * @return
