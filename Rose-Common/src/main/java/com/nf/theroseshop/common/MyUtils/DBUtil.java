package com.nf.theroseshop.common.MyUtils;
...
public class DBUtil {
	...
	static String DBURL="jdbc:mysql://localhost/yiji?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=UTF-8&useSSL=false";
